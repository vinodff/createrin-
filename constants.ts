...
export const STYLES_CONFIG: Record<CaptionStyle, StyleConfig> = {
  ...
  [CaptionStyle.RAPID_SPRINT]: { name:"Rapid Sprint",category:"BOLD",fontFamily:"'Montserrat', sans-serif",fontSize:58,fontWeight:900,textColor:"#FFFFFF",strokeColor:"#000000",strokeWidth:9,shadowColor:"#000000",shadowBlur:0,shadowOffsetY:10,animation:"POP",uppercase:true,displayMode:"BLOCK"},
  ...
  [CaptionStyle.COLOR_POP_VIRAL]: { name:"Standard Pop",category:"BOLD",fontFamily:"'Oswald', sans-serif",fontSize:60,fontWeight:900,textColor:"#FFFFFF",strokeColor:"#000000",strokeWidth:9,shadowColor:"#000000",shadowBlur:0,shadowOffsetY:9,animation:"POP",uppercase:true,displayMode:"BLOCK"},
  ...
  [CaptionStyle.GLOW_DREAMY]: { name:"Soft Dream",category:"GLOW",fontFamily:"'Poppins', sans-serif",fontSize:52,fontWeight:700,textColor:"#FFFFFF",shadowColor:"#F472B6",shadowBlur:50,animation:"SCALE_UP",displayMode:"BLOCK"},
  [CaptionStyle.GLOW_RADIOACTIVE]: { name:"Radioactive",category:"GLOW",fontFamily:"'Orbitron', sans-serif",fontSize:50,fontWeight:900,textColor:"#CCFF00",shadowColor:"#84CC16",shadowBlur:40,strokeColor:"#3D5F00",strokeWidth:2,animation:"POP",uppercase:true,displayMode:"BLOCK"},
  [CaptionStyle.GLOW_CYBER_BLUE]: { name:"Cyber Blue",category:"GLOW",fontFamily:"'Nunito', sans-serif",fontSize:56,fontWeight:900,textColor:"#E0F2FE",shadowColor:"#0EA5E9",shadowBlur:55,animation:"SCALE_UP",displayMode:"BLOCK"},
  [CaptionStyle.GLOW_GOLDEN_HOUR]: { name:"Golden Hour",category:"GLOW",fontFamily:"'Playfair Display', serif",fontSize:54,fontWeight:700,textColor:"#FEF3C7",shadowColor:"#F59E0B",shadowBlur:50,animation:"SCALE_UP",displayMode:"BLOCK"},
  [CaptionStyle.GLOW_DEEP_SPACE]: { name:"Deep Space",category:"GLOW",fontFamily:"'Montserrat', sans-serif",fontSize:54,fontWeight:900,textColor:"#FFFFFF",gradientColors:["#7C3AED","#3B82F6"],shadowColor:"#7C3AED",shadowBlur:40,animation:"POP",uppercase:true,displayMode:"BLOCK"},

  // â”€â”€â”€ HIGHLIGHT â”€â”€â”€
  [CaptionStyle.HIGHLIGHT_MARKER]: { name:"Yellow Marker",category:"HIGHLIGHT",fontFamily:"'Permanent Marker', cursive",fontSize:48,fontWeight:400,textColor:"#1A1A1A",backgroundColor:"#FDE047",backgroundPadding:16,backgroundBorderRadius:4,rotationVariance:3,shadowColor:"rgba(0,0,0,0.4)",shadowBlur:8,shadowOffsetY:5,animation:"POP",displayMode:"BLOCK"},
  ...
  [CaptionStyle.HIGHLIGHT_BLACK_BOX]: { name:"Bold Box",category:"HIGHLIGHT",fontFamily:"'Inter', sans-serif",fontSize:50,fontWeight:900,textColor:"#FFFFFF",backgroundColor:"#000000",backgroundPadding:22,backgroundBorderRadius:0,animation:"POP",uppercase:true,displayMode:"BLOCK"},
  [CaptionStyle.HIGHLIGHT_PAPER_CUT]: { name:"Paper Cut",category:"HIGHLIGHT",fontFamily:"'Fredoka', sans-serif",fontSize:52,fontWeight:700,textColor:"#111827",backgroundColor:"#FFFFFF",backgroundPadding:18,backgroundBorderRadius:10,shadowColor:"rgba(0,0,0,0.65)",shadowBlur:10,shadowOffsetY:8,animation:"SCALE_UP",displayMode:"BLOCK"},
  [CaptionStyle.HIGHLIGHT_SKETCH]: { name:"Sketchy",category:"HIGHLIGHT",fontFamily:"'Caveat', cursive",fontSize:58,fontWeight:700,textColor:"#FFFFFF",strokeColor:"#000000",strokeWidth:3,backgroundColor:"#1E293B",backgroundPadding:16,backgroundBorderRadius:26,shadowColor:"rgba(0,0,0,0.6)",shadowBlur:12,animation:"POP",displayMode:"BLOCK"},
  ...
  // â”€â”€â”€ KINETIC â”€â”€â”€
  [CaptionStyle.KINETIC_IMPACT]: { name:"Impact Heavy",category:"KINETIC",fontFamily:"'Anton', sans-serif",fontSize:72,fontWeight:400,textColor:"#FFFFFF",strokeColor:"#000000",strokeWidth:12,shadowColor:"#000000",shadowBlur:0,shadowOffsetY:14,animation:"POP",uppercase:true,displayMode:"BLOCK"},
  [CaptionStyle.KINETIC_RAPID]: { name:"Rapid Fire",category:"KINETIC",fontFamily:"'Montserrat', sans-serif",fontSize:62,fontWeight:900,textColor:"#F97316",strokeColor:"#FFFFFF",strokeWidth:6,shadowColor:"#7C2D12",shadowBlur:0,shadowOffsetY:10,animation:"SCALE_UP",uppercase:true,displayMode:"BLOCK"},
  [CaptionStyle.KINETIC_STOMP]: { name:"Stomp",category:"KINETIC",fontFamily:"'Titan One', cursive",fontSize:60,fontWeight:400,textColor:"#FFFFFF",strokeColor:"#000000",strokeWidth:7,shadowColor:"#000000",shadowBlur:0,shadowOffsetY:18,animation:"POP",uppercase:true,displayMode:"BLOCK"},
  [CaptionStyle.KINETIC_TILT]: { name:"Tilt Pop",category:"KINETIC",fontFamily:"'Luckiest Guy', cursive",fontSize:64,fontWeight:400,textColor:"#FACC15",strokeColor:"#000000",strokeWidth:9,rotationVariance:14,shadowColor:"#854D0E",shadowBlur:0,shadowOffsetY:10,animation:"POP",uppercase:true,displayMode:"BLOCK"},
  [CaptionStyle.KINETIC_ZOOMER]: { name:"Zoomer",category:"KINETIC",fontFamily:"'Inter', sans-serif",fontSize:74,fontWeight:900,textColor:"#FFFFFF",shadowColor:"rgba(255,255,255,0.3)",shadowBlur:25,animation:"SCALE_UP",uppercase:true,displayMode:"BLOCK"},
  ...
  // â”€â”€â”€ VIRAL â”€â”€â”€
  [CaptionStyle.VIRAL_COMIC]: { name:"Comic Loud",category:"VIRAL",fontFamily:"Bangers, cursive",fontSize:62,fontWeight:400,textColor:"#FFD700",strokeColor:"#000000",strokeWidth:12,shadowColor:"#7B3F00",shadowBlur:0,shadowOffsetY:12,animation:"POP",uppercase:true,displayMode:"BLOCK"},
  [CaptionStyle.VIRAL_PRO_CLEAN]: { name:"Pro Clean",category:"VIRAL",fontFamily:"'Inter', sans-serif",fontSize:56,fontWeight:900,textColor:"#FFFFFF",shadowColor:"#3B82F6",shadowBlur:30,shadowOffsetY:6,animation:"SCALE_UP",uppercase:true,displayMode:"BLOCK"},
  [CaptionStyle.VIRAL_LOUD_NEON]: { name:"Loud Neon",category:"VIRAL",fontFamily:"'Orbitron', sans-serif",fontSize:52,fontWeight:900,textColor:"#FFFFFF",strokeColor:"#FF00FF",strokeWidth:6,shadowColor:"#00FFFF",shadowBlur:40,animation:"SCALE_UP",uppercase:true,displayMode:"BLOCK"},
  [CaptionStyle.VIRAL_HYPER_BOLD]: { name:"Hyper Bold",category:"VIRAL",fontFamily:"'Anton', sans-serif",fontSize:68,fontWeight:400,textColor:"#FFFF00",strokeColor:"#000000",strokeWidth:10,shadowColor:"#FF0000",shadowBlur:0,shadowOffsetY:16,animation:"POP",uppercase:true,displayMode:"BLOCK"},
  ...
  [CaptionStyle.CAPCUT_CLASSIC]: { name:"CapCut Classic",category:"VIRAL",fontFamily:"'Montserrat', sans-serif",fontSize:60,fontWeight:900,textColor:"#FFFFFF",activeTextColor:"#FFD700",strokeColor:"#000000",strokeWidth:8,shadowColor:"rgba(0,0,0,0.9)",shadowBlur:8,shadowOffsetY:4,animation:"POP",uppercase:true,displayMode:"WORD",colorBehavior:"WORD_POP"},
  ...
  [CaptionStyle.BOUNCE_WAVE]: { name:"Bounce Wave",category:"VIRAL",fontFamily:"'Poppins', sans-serif",fontSize:58,fontWeight:900,textColor:"#00D4FF",activeTextColor:"#FFFFFF",strokeColor:"#003366",strokeWidth:6,shadowColor:"#0077FF",shadowBlur:20,animation:"SCALE_UP",uppercase:true,displayMode:"WORD",colorBehavior:"WORD_POP"},
  [CaptionStyle.RAINBOW_BURST]: { name:"Rainbow Burst",category:"VIRAL",fontFamily:"'Fredoka', sans-serif",fontSize:62,fontWeight:700,textColor:"#FF6B6B",activeTextColor:"#FFFFFF",strokeColor:"#000000",strokeWidth:8,shadowColor:"rgba(0,0,0,0.7)",shadowBlur:10,shadowOffsetY:5,animation:"POP",uppercase:true,displayMode:"WORD",colorBehavior:"CONTEXTUAL"},
  [CaptionStyle.VIRAL_WORD_SLAM]: { name:"Word Slam",category:"KINETIC",fontFamily:"'Anton', sans-serif",fontSize:80,fontWeight:400,textColor:"#FFFFFF",strokeColor:"#000000",strokeWidth:14,shadowColor:"#FF0000",shadowBlur:20,shadowOffsetY:12,animation:"POP",uppercase:true,displayMode:"WORD",colorBehavior:"WORD_POP"},
  [CaptionStyle.KARAOKE_FIRE]: { name:"Karaoke Fire",category:"NEON",fontFamily:"'Poppins', sans-serif",fontSize:50,fontWeight:900,textColor:"rgba(255,255,255,0.25)",activeTextColor:"#FF6B00",strokeColor:"#3D1A00",strokeWidth:2,shadowColor:"#FF4500",shadowBlur:35,animation:"KARAOKE",displayMode:"WORD",colorBehavior:"ACTIVE_ONLY"},
  [CaptionStyle.WORD_CINEMATIC]: { name:"Cinematic",category:"MINIMAL",fontFamily:"'Inter', sans-serif",fontSize:52,fontWeight:300,textColor:"rgba(255,255,255,0.35)",activeTextColor:"#FFFFFF",shadowColor:"rgba(0,0,0,0.95)",shadowBlur:20,shadowOffsetY:2,animation:"SCALE_UP",uppercase:false,displayMode:"WORD",colorBehavior:"ACTIVE_ONLY"},
  [CaptionStyle.MINIMAL_WORD_FADE]: { name:"Minimal Fade",category:"MINIMAL",fontFamily:"'Nunito', sans-serif",fontSize:56,fontWeight:800,textColor:"rgba(255,255,255,0.25)",activeTextColor:"#FFFFFF",shadowColor:"rgba(0,0,0,0.8)",shadowBlur:15,animation:"SCALE_UP",uppercase:false,displayMode:"WORD",colorBehavior:"ACTIVE_ONLY"},
  [CaptionStyle.GRADIENT_SHIFT]: { name:"Gradient Shift",category:"GLOW",fontFamily:"'Poppins', sans-serif",fontSize:58,fontWeight:900,textColor:"#FFFFFF",activeTextColor:"#00FFFF",gradientColors:["#7B2FBE","#00D4FF","#FF6BCB"],shadowColor:"rgba(123,47,190,0.6)",shadowBlur:30,animation:"SCALE_UP",uppercase:true,displayMode:"WORD",colorBehavior:"FIXED"},
  [CaptionStyle.WORD_GLITTER]: { name:"Glitter",category:"GLOW",fontFamily:"'Fredoka', sans-serif",fontSize:58,fontWeight:700,textColor:"#FFB6C1",activeTextColor:"#FFFFFF",gradientColors:["#FF6BCB","#FFADD2","#C084FC"],shadowColor:"rgba(255,107,203,0.7)",shadowBlur:30,animation:"POP",displayMode:"WORD",colorBehavior:"FIXED"},
  [CaptionStyle.NEON_WORD_WAVE]: { name:"Neon Wave",category:"NEON",fontFamily:"'Orbitron', sans-serif",fontSize:52,fontWeight:900,textColor:"rgba(0,255,255,0.4)",activeTextColor:"#00FFFF",strokeColor:"#003344",strokeWidth:3,shadowColor:"#00FFFF",shadowBlur:40,animation:"SCALE_UP",uppercase:true,displayMode:"WORD",colorBehavior:"ACTIVE_ONLY"},
  [CaptionStyle.WORD_SPOTLIGHT_REVEAL]: { name:"Spotlight Reveal",category:"ART",fontFamily:"'Montserrat', sans-serif",fontSize:60,fontWeight:900,textColor:"rgba(255,255,255,0.2)",activeTextColor:"#FFFFFF",shadowColor:"rgba(255,255,255,0.8)",shadowBlur:35,animation:"SCALE_UP",uppercase:true,displayMode:"WORD",colorBehavior:"ACTIVE_ONLY"},
  [CaptionStyle.WORD_SHAKE_IMPACT]: { name:"Shake Impact",category:"KINETIC",fontFamily:"'Anton', sans-serif",fontSize:72,fontWeight:400,textColor:"#FFFFFF",activeTextColor:"#FF3B3B",strokeColor:"#000000",strokeWidth:10,shadowColor:"#FF0000",shadowBlur:15,shadowOffsetY:10,animation:"POP",uppercase:true,displayMode:"WORD",colorBehavior:"WORD_POP"},
  [CaptionStyle.WORD_OUTLINED_POP]: { name:"Outlined Pop",category:"BOLD",fontFamily:"'Bebas Neue', display",fontSize:68,fontWeight:900,textColor:"#FFFFFF",activeTextColor:"#FFEE00",strokeColor:"#000000",strokeWidth:14,shadowColor:"#000000",shadowBlur:0,shadowOffsetY:10,animation:"POP",uppercase:true,displayMode:"WORD",colorBehavior:"WORD_POP"},
